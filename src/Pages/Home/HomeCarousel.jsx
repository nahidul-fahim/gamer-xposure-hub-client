            ...
            >
                <SwiperSlide>
                    <div style={{
                        ...
                        <div className="h-[100vh] flex flex-col gap-3 justify-center items-center p-5">
                            <h2 className="text-6xl font-extrabold text-white text-center">START YOUR ENGINES!</h2>
                ...
                <SwiperSlide>
                    <div className="flex flex-col gap-3 justify-center items-center p-5" style={{
                        ...
                        <h2 className="text-6xl font-extrabold text-white text-center">LAST ONE STANDING!</h2>
                ...
                <SwiperSlide>
                    <div className="flex flex-col gap-3 justify-center items-center p-5" style={{
                        ...
                        <h2 className="text-6xl font-extrabold text-white text-center">FUEL YOUR FANTASY!</h2>
                ...
                <SwiperSlide>
                    <div className="flex flex-col gap-3 justify-center items-center p-5" style={{
                        ...
                        <h2 className="text-6xl font-extrabold text-white text-center">GAME ON! GOAL ON!</h2>
