...
const Header = () => {
    ...
    const links = <>
        ...
        <NavLink to="/ticket" className={`${location.pathname === "/login" || location.pathname === "/signup" ? "lg:text-black" : "lg:text-white"} font-bold`}>Buy ticket</NavLink>
    </>;
                ...
                <div className="navbar bg-[#ffffff00]">
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-5 shadow bg-base-100 rounded-box w-52 space-y-5">
                                {links}
                            </ul>
                        </div>
